...
public class App {
    ...
    public static ArrayList<String> connectingEdges = new ArrayList<String>();
    public static ArrayList<String> nextEdges = new ArrayList<String>();
    ...
    public static void main(String[] args) throws Exception {
        ...
        for(int i=0; i+1 < 33; i++) { // Change i for the number of nodes you want (i*i)
	        gen.nextEvents();
        }
        ...
        // Interrupt the nodes
        interruptNodes(graph, currentNodes, connectingEdges);*/

        currentNodes.add("0_0");
        while (true) {
            interruptNodes(graph, currentNodes, connectingEdges);
            currentNodes = nextNodes;
            connectingEdges = nextEdges;
            nextNodes = new ArrayList<String>();
            nextEdges = new ArrayList<String>();
        }
    }
